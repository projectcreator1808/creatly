            ...
            <div class="dashboard-nav">
                <div class="dashboard-nav-inner">
                    ...
                    <ul data-submenu-title="<?php _e("Organize and Manage") ?>" >
                        <li><a href="#"><i class="icon-material-outline-assignment"></i> <?php _e("Services") ?></a>
                            <ul>
                                <?php
                                if($usertype == "user"){
                    ...
                    <ul data-submenu-title="<?php _e("Profile") ?>">
                        ...
                        if($usertype == "user"){
                            ...
                            echo '<li><a href="'.url("FAVUSERS",false) .'"><i class="icon-feather-heart"></i> '.__("Bookmark Freelancers") .'</a></li>';
                        }
                        ?>
                    </ul>
