                            ...
                            <li><a href="#"><?php _e("Dashboard") ?></a>
                                <ul class="dropdown-nav">
                                    ...
                                    <?php if($config['quickchat_socket_on_off'] == 'on' || $config['quickchat_ajax_on_off'] == 'on'){ ?>
                                        <li><a href="<?php url("MESSAGE") ?>"><?php _e("Message") ?></a></li>
                                    <?php } ?>
                                    <li><a href="#"><?php _e("Gig Services") ?></a>
                                        <ul class="dropdown-nav">
                                            <?php
                                            if($usertype == "user"){
                                                echo '<li><a href="'.url("POST_SERVICE",false).'">'.__("Post a Service").'</a></li>';
                                                echo '<li><a href="'.url("MYSERVICES",false).'">'.__("My Services").'</a></li>';
                                            }
                                            ?>
                                            <li><a href="<?php url("SERVICE_ORDERS") ?>"><?php _e("Manage Orders") ?></a></li>
                                            <li><a href="<?php url("SERVICE_ORDERS") ?>?status=progress"><?php _e("My Progress Orders") ?></a></li>
                                        </ul>
                                    </li>
                                    <li><a href="<?php url("") ?>"><?php _e("Projects") ?></a>
                                        <ul class="dropdown-nav">
                                            <?php
                                            if($usertype == "employer"){
                                                echo '<li><a href="'.url("POST-PROJECT",false).'">'.__("Post a Project").'</a></li>';
                                            }
                                            ?>
