                        ...
                        <div class="job-listing <?php if($item['highlight']){ echo 'highlight';}?>">
                            ...
                            <div class="job-listing-footer with-icon">
                                ...
                                <?php if($usertype == 'user') { ?>
                                    <span class="fav-icon set-item-fav <?php if($item['favorite']) { echo 'added'; }?>" data-item-id="<?php _esc($item['id'])?>" data-userid="<?php _esc($user_id)?>" data-post-type="job" data-action="setFavAd"></span>
                                <?php }?>
                            </div>
                        </div>
                    <?php } ?>
