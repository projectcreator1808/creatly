...
if (isset($_GET['action'])){
    ...
    if ($_GET['action'] == "dispute_milestone") { dispute_milestone(); }
    if ($_GET['action'] == "cancel_milestone") { cancel_milestone(); }
    if ($_GET['action'] == "reject_milestone") { reject_milestone(); }
    if ($_GET['action'] == "request_release_milestone") { request_release_milestone(); }
    if ($_GET['action'] == "request_dispute_milestone") { request_dispute_milestone(); }
    if ($_GET['action'] == "request_deliver_milestone") { request_deliver_milestone(); }
    if ($_GET['action'] == "request_reject_milestone") { request_reject_milestone(); }

    if ($_GET['action'] == "request_accept_reject_milestone") { request_accept_reject_milestone(); }
    if ($_GET['action'] == "request_deny_reject_milestone") { request_deny_reject_milestone(); }
    
    if ($_GET['action'] == "accept_reject_milestone") { accept_reject_milestone(); }
    if ($_GET['action'] == "deny_reject_milestone") { deny_reject_milestone(); }
    
    if ($_GET['action'] == "split_milestone") { split_milestone(); }
    if ($_GET['action'] == "request_split_milestone") { request_split_milestone(); }
    
    if ($_GET['action'] == "accept_split_milestone") { accept_split_milestone(); }
    if ($_GET['action'] == "deny_split_milestone") { deny_split_milestone(); }
    if ($_GET['action'] == "request_accept_split_milestone") { request_accept_split_milestone(); }
    if ($_GET['action'] == "request_deny_split_milestone") { request_deny_split_milestone(); }
...
function request_reject_milestone(){
    global $config,$lang;
...
function request_accept_reject_milestone(){
    global $config,$lang;
...
function request_deny_reject_milestone(){
    global $config,$lang;
...
function request_split_milestone(){
    global $config,$lang;
...
function accept_split_milestone(){
        global $config,$lang,$link;
    ...
    function request_accept_split_milestone(){
        global $config,$lang,$link;
    ...
    function request_deny_split_milestone(){
        global $config,$lang;
...
function accept_reject_milestone(){
    global $config,$lang;
...
function deny_reject_milestone(){
    global $config,$lang;
...
function request_dispute_milestone(){
    global $config,$lang,$link;
...
function request_deliver_milestone(){
    global $config,$lang,$link;
