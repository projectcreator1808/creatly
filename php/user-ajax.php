...
if (isset($_GET['action'])){
    ...
    if ($_GET['action'] == "request_release_milestone") { $milestoneMainManager->request_release(); }

    if ($_GET['action'] == "dispute_milestone") { $milestoneDisputeManager->dispute(); }
    if ($_GET['action'] == "request_dispute_milestone") { $milestoneDisputeManager->request_dispute(); }
    if ($_GET['action'] == "request_deliver_milestone") { $milestoneDisputeManager->request_deliver(); }

    if ($_GET['action'] == "reject_milestone") { $milestoneRejectManager->reject(); }
    if ($_GET['action'] == "request_reject_milestone") { $milestoneRejectManager->request_reject(); }
    if ($_GET['action'] == "request_accept_reject_milestone") { $milestoneRejectManager->request_accept_reject(); }
...
function create_milestone(){
    ...
    if(isset($_POST['id']))
    {
        ...
        if ($milestone) {
            $result['success'] = false;
            $result['message'] = __("Milestone exists");
            die(json_encode($result));
        }
