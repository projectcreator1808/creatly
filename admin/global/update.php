    ...
    foreach ($versionList as $aV)
    {
        if ( $aV > $config['version']) {
            ...
            if ( !is_file(  $update_dir.'QUICKLANCER-CMS-'.$aV.'.zip' )) {
                ...
                <div>
                    <ul>
                        <li>Step 1 : Upload QUICKLANCER-CMS-<?php echo $aV ?>.zip file  (manually upload the zip file in admin/uploads folder via FTP or Cpanel.)</li>
                    ...
                    if ($output['success']) {
                        ...
                        echo '<div class="app-layout-content">
                                <div class="alert alert-warning" style="margin: 10px 10px 0 10px">
                                    ...
                                    <a class="text-info" style="cursor: pointer" href="<?php _esc(ADMINURL);?>global/setting.php#quickad_purchase_code"><strong>Click here</strong></a>
                                </div>
                            </div>';
                    }
                }
