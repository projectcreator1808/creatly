        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="pull-right">
                    <a class="btn btn-sm btn-warning" href="<?php _esc(ADMINURL);?>global/setting.php#quickad_email">Email Configuration Setting</a>
                </div>
            </div>
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-0">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <textarea name="<?php _esc($template['message'])?>" rows="6" class="form-control" id="pageContent" placeholder="Enter Message"><?php echo get_option($template['message']) ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
