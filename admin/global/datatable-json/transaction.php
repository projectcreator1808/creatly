...
foreach ($queryRecords as $row) {
    ...
    if($row['transaction_method'] == 'membership'){
        ...
        $premium = '<span class="label label-default">'.__("Order Service").'</span>';
    }
    else if($row['transaction_method'] == 'order_completed'){
        $premium = '<span class="label label-default">'.__("Order Completed").'</span>';
    }
    else if($row['transaction_method'] == 'project_fee'){
        $premium = '<span class="label label-default">'.__("Project Fee").'</span>';
    }
    else if($row['transaction_method'] == 'deposit'){
        $premium = '<span class="label label-default">'.__("Deposit").'</span>';
    }
    else if($row['transaction_method'] == 'milestone_created' || $row['transaction_method'] == 'milestone_released'){
        $premium = '<span class="label label-default">'.__("Milestone").'</span>';
    }else if($row['transaction_method'] == 'banner_advertise'){
        $premium = '<span class="label label-default">'.__("Banner advertise").'</span>';
    }
    else{
