jQuery(function($) {
    ...
    $('#ajax-send-custom-fields').on('click', function(e) {
        ...
        $.ajax({
            ...
            data      : { action: 'save_custom_fields', post_type: $fields.data('post_type'), csrf_token : quickadL10n.csrf_token, fields: JSON.stringify(data), cf_per_service: $cf_per_service.val() },
            complete  : function() {
